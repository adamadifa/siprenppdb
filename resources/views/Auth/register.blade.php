                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <p class="px-2">Silahkan Isi Kolom Berikut Untuk Membuat Akun</p>
                                                ...
                                                <form action="/storeregister" method="post">
                                                    ...
                                                    <div class="form-label-group">
                                                        <select name="unit" id="unit" class="form-control">
                                                            ...
                                                            @foreach ($unit as $d)
                                                            <option value="{{ $d->nama_unit }}">{{ $d->nama_unit }}</option>
                                                            @endforeach
                                                        </select>

                                                    </div>
                                                    <x-inputpassword label="Password" field="password" icon="feather icon-lock" />
                                                    <x-inputpassword label="Konfirmasi Password" field="confirm_password" icon="feather icon-lock" />
                                                    ...
                                                    <a href="/" class="btn btn-outline-success float-left btn-inline mb-50">Login</a>
