                                    ...
                                    <ul class="activity-timeline timeline-left list-unstyled">
                                        <li>
                                            ...
                                            <div class="timeline-info">
                                                ...
                                                <span class="font-small-3">Status : </span><span class="font-small-3 success">Completed <i
                                            ...
                                            <div class="timeline-info">
                                                ...
                                                @else
                                                    @if ($pembayaran->status === '0')
                                                        <span class="font-small-3 warning">Menunggu Konfirmasi <i class="fa fa-history"></i></span>
                                                    @else
                                                        <a href="/pendaftar/{{ \Crypt::encrypt($pendaftar->no_pendaftaran) }}/cetak" target="_blank"
                                                            class="btn btn-xs btn-primary"><i class="fa fa-file-text mr-1"></i> Cetak Formulir </a>
                                                    @endif
                                                @endif
